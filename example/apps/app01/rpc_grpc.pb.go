...
// ServiceClient is the impl API for Service service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type ServiceClient interface {
	Create(ctx context.Context, in *CreateUserReq, opts ...grpc.CallOption) (*User, error)
	List(ctx context.Context, in *ListUserReq, opts ...grpc.CallOption) (*UserSet, error)
}
...
func (c *serviceClient) Create(ctx context.Context, in *CreateUserReq, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (c *serviceClient) List(ctx context.Context, in *ListUserReq, opts ...grpc.CallOption) (*UserSet, error) {
	out := new(UserSet)
...
type ServiceServer interface {
	...
	List(context.Context, *ListUserReq) (*UserSet, error)
...
func (UnimplementedServiceServer) Create(context.Context, *CreateUserReq) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedServiceServer) List(context.Context, *ListUserReq) (*UserSet, error) {
...
func _Service_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).Create(ctx, req.(*CreateUserReq))
	}
...
func _Service_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).List(ctx, req.(*ListUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
